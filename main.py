...
def _print_controls() -> None:
    ...
    print("    L              learn mode (gesture training)")
    print("    T              test mode (model-assisted control)")
    print("    V              validation panel (in test mode)")
    print("    G              guided/manual toggle (in learn mode)")
